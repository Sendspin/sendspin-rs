...
pub struct BufferPool {
    pool: Arc<ArrayQueue<Vec<SendspinSample>>>,
    capacity: usize,
}
...
impl BufferPool {
    ...
    pub fn new(pool_size: usize, buffer_capacity: usize) -> Self {
        ...
        for _ in 0..pool_size {
            ...
            buf.resize(buffer_capacity, SendspinSample::ZERO);
    ...
    pub fn get(&self) -> Vec<SendspinSample> {
        self.pool
            .pop()
    ...
    pub fn put(&self, mut buf: Vec<SendspinSample>) {
        buf.clear();
